...
# Set wd
getwd()
setwd("/Users/davidadams/pycharmprojects/module_15/AutosRUs")
getwd()
...
# T-test to determine if PSI by manufacturing lot is statistically different from population mean of 1500 lbs per sq in
